...
OUTPUT_DIR = '/Users/minji/Documents/minton-angle/backend/data/standard/0224_resources/wooil/wooil_score_result_6'
...
class GolfAnalyzer:
    ...
    def analyze_swing_sequence(self):
        ...
        if ready_f != -1 and back_f != -1 and back_f >= ready_f:
            # np.linspace는 시작과 끝점을 포함하므로 back_f(백스윙) 프레임은 반드시 포함됩니다.
